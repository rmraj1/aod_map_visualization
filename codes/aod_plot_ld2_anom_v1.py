...
data1= netCDF4.Dataset(r'D:\extra\assgnmnet\data3\dout1\aodavg_ld2_2018.nc','r')
data2= netCDF4.Dataset(r'D:\extra\assgnmnet\data3\dout1\aodavg_ld2_2019.nc','r')
data3= netCDF4.Dataset(r'D:\extra\assgnmnet\data3\dout1\aodavg_ld2_2020.nc','r')
data4= netCDF4.Dataset(r'D:\extra\assgnmnet\data3\dout1\anom_aod_ld2_2018.nc','r')
data5= netCDF4.Dataset(r'D:\extra\assgnmnet\data3\dout1\anom_aod_ld2_2019.nc','r')
...
in4= data4.variables['ANOM_2018_LD2'][::-1]
in5= data5.variables['ANOM_2019_LD2'][::-1]
...
mp.drawmeridians(meridians,labels=[1,0,0,1],linewidth=0.0)
mp.readshapefile(r"D:\extra\assgnmnet\data1\modisdata\out\India_State_Boundary_Updated", name="India_State_Boundary_Updated")
plt.title("AOD Anomaly 2018-2020 LD2")
...
mp.readshapefile(r"D:\extra\assgnmnet\data1\modisdata\out\India_State_Boundary_Updated", name="India_State_Boundary_Updated")
plt.title("AOD Anomaly 2019-2020 LD2")



plt.savefig(r"D:\extra\assgnmnet\presentatiom\final_figures\anom_ld2_aod.png",
            bbox_inches ="tight",
            pad_inches = 1,
            transparent = True,
            facecolor ="w",
